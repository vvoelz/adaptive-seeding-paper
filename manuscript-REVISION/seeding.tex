...
Maximization of the likelihood function above, with the additional constraint of fixed populations $\pi_i$, yields a similar self-consistent equation that can be used to determine a set of Lagrange multipliers,\cite{TrendelkampSchroer:2016bz}
\begin{equation}
...
NTL9(1-39) domain is a 39-residue truncation variant of the N-terminal domain of ribosomal protein L9, whose folded state consists of an $\alpha$-helix and three-strand $\beta$-sheet. NTL9(1-39), which has a folding relaxation time of $\sim$1.5 ms at 25 $^{\circ}$C,\cite{Horng:2003gf} has been extensively probed by both experimental and computational studies.\cite{Cho:2005is,Voelz:2010hs,Schwantes:2013bp,Cho:2014fla, Baiz:2014gm} The K12M mutant of NTL9(1-39) is a fast-folding variant with a folding timescale of $\sim$700 $\mu$s at 25 $^{\circ}$C.\cite{Horng:2003gf,Cho:2004dp}


\begin{figure*}[ht!]
\includegraphics[width=0.8\paperwidth]{figures/tica_and_free_energy_GTT_NTL9_new.pdf}
...
\begin{figure*}[ht!]
\includegraphics[width=0.6\paperwidth]{figures/shaw_ipt_errors_log_with_picked_lagtime.pdf}
...
Molecular simulation trajectory data for GTT WW domain and K12M NTL9(1-39) were provided by Shaw et al.,\cite{LindorffLarsen:2011gl}  Our first objective was to construct high-quality reference MSMs from the available trajectory data, to be used as benchmarks against which we could compare adaptive seeding results.
...
\begin{figure*}[ht!]
\includegraphics[width=0.55\paperwidth]{figures/all_slowest_timescales_cluster_200_and_1000_10trajs_omi.pdf}% Here is how to import EPS art
...
\begin{figure*}[ht!]
\includegraphics[width=0.55\paperwidth]{figures/native_population_5trajs_cluster200_1000_omi_new.pdf}% Here is how to import EPS art
...
\begin{figure*}[ht!]
\includegraphics[width=0.55\paperwidth]{figures/native_population_10trajs_cluster200_1000_omi_new.pdf}% Here is how to import EPS art
